"""Discovery-layer tests for the Alembic migration parser.

Covers:
- TestScaffold — parser is registered via the MigrationParser protocol.
- TestDiscovery — directory / ini-file detection and rejection of non-Alembic layouts.
- TestCollectRevisions — raw revision-file collection into internal `_Revision` records.
- TestSymlinkHardening — refusal to walk symlinks that escape the project root.
"""
